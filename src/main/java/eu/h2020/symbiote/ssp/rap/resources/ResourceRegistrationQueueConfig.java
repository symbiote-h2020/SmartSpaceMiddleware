...
import eu.h2020.symbiote.ssp.rap.ResourceRegistrationHandler;
...
public class ResourceRegistrationQueueConfig {
    ...
    @Bean
    ResourceRegistrationHandler resourceReceiver() {
        return new ResourceRegistrationHandler();
    }

    @Bean(name=RapDefinitions.RESOURCE_REGISTRATION_QUEUE + "Listener")
    MessageListenerAdapter resourceRegistrationListenerAdapter(ResourceRegistrationHandler receiver) {
    ...
    MessageListenerAdapter resourceUnRegistrationListenerAdapter(ResourceRegistrationHandler receiver) {
    ...
    MessageListenerAdapter resourceUpdatedListenerAdapter(ResourceRegistrationHandler receiver) {
