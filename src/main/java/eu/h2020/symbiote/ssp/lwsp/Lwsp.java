...
*/
    ...
    private String get_mti(String Data) throws JSONException
       {
        JSONObject jsonData;
...
*/
	...
	public Lwsp(String data, String AllowedCipher) throws Exception 
	   {
		String out="";
		...
		this.data=StripHTTPHeader(data);
...
*/           
                ...
                if ((this.cipher=cryptochoose(jsonData.getString("cp"),AllowedCipher))!="NONE")
                   {
                    //parse input JSON
                    if (! regexvalidator(this.macaddress=jsonData.getString("SDEVmac"),macaddressREGEX)) {out=this.error_ff;}
                    if (! regexvalidator(this.snonce=jsonData.getString("nonce"),nonceREGEX)) {out=this.error_fd;}
...
/*
                 ...
                 (__)\_)__) \__/ \_/\_/\____/(__)(____/
*/           
                throw new Exception("InvalidJason");
		  }                  
	   }
/*
